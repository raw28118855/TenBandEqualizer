...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_D1686843F09E4A96A061CA36DE6C466B
#define AU_COCOA_VIEW_NAME AUCocoaView_D1686843F09E4A96A061CA36DE6C466B
...
const char* kAAXBundleID = "rackafxuser.aax.10bandequalizer.bundleID";
const char* kVST3BundleID = "rackafxuser.vst3.10bandequalizer.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "rackafxuser.au.10bandequalizer.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "10 band equalizer";     // 31 chars max for AAX
const char* kShortPluginName = "10 band equaliz";    // 15 chars max for AAX
const char* kAUBundleName = "10 band equalizer";
...
const char* kVSTFUID = "{D1686843-F09E-4A96-A061-CA36DE6C466B}"; /// NOTE: you need the enclosing { }
